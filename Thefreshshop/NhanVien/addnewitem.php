          ...
          <form action="./crud.php" method="post" id="form-chitiet" enctype="multipart/form-data">
            <h4 style="text-align: center;">Thêm sản phẩm mới </h4>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="mshh" name="mshh" disabled placeholder="Mã số hàng hóa sẽ được sinh tự động">
              </div>
              <div class="form-group">
              ...
              <div class="img_upload img-item">
                ...
                <div class="img">
                  <img id="output"class="output" style="width: 195px; height: 195px; ">
                  <p id="btn">+</p>
                  <input type="file" id="img_1"  onchange="loadFile(event,'output')" name="img1">
                </div>
                <div class="img">
                  <img class="output" id="output2" style="width: 195px; height: 195px;">
                  <p id="btn">+</p>
                  <input type="file" id="img_2" onchange="loadFile(event,'output2')" name="img2">
                </div>
                <div class="img">
                  <img class="output" id="output3" style="width: 195px; height: 195px;">
                  <p id="btn">+</p>
              ...
              <button type="submit" class="btn btn-success" value="addnew" name="btn" style="float: right; margin-bottom:10px ;">Cập nhật</button>
            </form>
       </div>
      </div>
